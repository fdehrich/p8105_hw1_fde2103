...
```
    ...
    ##  [1] 0.74199955 0.00000000 0.18670947 0.00000000 1.57285152 0.68264126
    ##  [7] 1.34980295 0.02879041 1.55858782 0.23436675
...
```
    ...
    ##  [1]  1.48399911 -0.45557680  0.37341893 -0.19132931  3.14570305  1.36528251
    ##  [7]  2.69960589  0.05758081  3.11717563  0.46873350
...
The data provides various types of information about penguins (species,
island, two types of bill measurements, two types of flipper
measurements, body mass, sex, and year). There are some missing values
(NA’s).
